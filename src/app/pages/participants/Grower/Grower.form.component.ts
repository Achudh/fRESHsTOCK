...
@Component({
	selector: 'form-Grower',
	templateUrl: 'Grower.form.component.html'
})

export class GrowerForm {
	...
	ionViewWillEnter(){
		if(this.formType == 'Update'){
			...
			loading.present();
			return this.serviceGrower.get(this.participantId).then((participant) => {
	...
	addParticipant(){
		...
		this.serviceGrower.add(this.form.value).then(() =>{
	...
	updateParticipant(){
		...
		this.serviceGrower.update(disabledIdentifier.value, this.form.value).then(() =>{
