...
describe('TransactionsPage', () => {
	...
	it('should initialize with all transactions',() => {
		expect(component.transactionList).toEqual([{'name':'TemperatureReading','component':TemperatureReadingPage},{'name':'ShipmentReceived','component':ShipmentReceivedPage},{'name':'SetupDemo','component':SetupDemoPage}]);
	});
